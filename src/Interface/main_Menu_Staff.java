//This class contains the user interface for the staff main menu
...
public class main_Menu_Staff {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					main_Menu_Staff window = new main_Menu_Staff();
	...
	private void initialize() {
		...
		//when the sell car button is clicked the current window is closed and the sell car windowis opened
